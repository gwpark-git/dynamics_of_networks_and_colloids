...
namespace GEOMETRY
{
  ...
  double minimum_image_convention_simple_shear(TRAJECTORY& TRAJ, MKL_LONG target_t, const MKL_LONG shear_axis, const MKL_LONG shear_grad_axis, const double shift_factor);
