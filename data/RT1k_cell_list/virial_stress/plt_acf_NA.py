...
dat_NP0400_NA20 = (loadtxt('RF_NP0400_NA2NC.dat')[:,1]/(2.*1000.))[1000:]
acf_NP0400_NA20 = acf_gro(dat_NP0400_NA20)
t_acf_NP0400_NA20 = arange(size(acf_NP0400_NA20))/100.

dat_NP0400 = (loadtxt('RF_NP0400_RT1k.dat')[:,1]/(2.*1000.))[1000:size(dat_NP0400_NA20)]
acf_NP0400 = acf_gro(dat_NP0400)
...
plt.plot(t_acf_NP0400, acf_NP0400/acf_NP0400[0], 'b-')
plt.plot(t_acf_NP0400_NA20, acf_NP0400_NA20/acf_NP0400_NA20[0], 'r-')
plt.axis([0, 10, -0.2, 1.0])
plt.grid()
plt.show()
