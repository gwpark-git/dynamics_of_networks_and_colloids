...
MSD_EQ_NP0400 = loadtxt('MSD_EQ_NP0400.dat')[:,1]
Nt_EQ_NP0400 = size(MSD_EQ_NP0400)
t_EQ_NP0400 = arange(Nt_EQ_NP0400)/100.
reg_EQ_NP0400 = linregress(t_EQ_NP0400[Nt_EQ_NP0400/2:], MSD_EQ_NP0400[Nt_EQ_NP0400/2:])

MSD_EQ_NP1000 = loadtxt('MSD_EQ_NP1000.dat')[:,1]
Nt_EQ_NP1000 = size(MSD_EQ_NP1000)
t_EQ_NP1000 = arange(Nt_EQ_NP1000)/100.
...
plt.plot(t_EQ_NP0400, MSD_EQ_NP0400, 'b-', linewidth=3, alpha=0.3, label = r'Np=0400 (repulsive Brownian), slope=%4.1f, $\tilde{D}$=%4.2f, $\tau_c$=%4.2f $\tau_0$'%(reg_EQ_NP0400[0], reg_EQ_NP0400[0]/6., 1/(reg_EQ_NP0400[0]/6.)))

plt.plot(t_NP0400, MSD_NP0400, 'b-', label = r'Np=0400 (Rt=10), slope=%4.1f, $\tilde{D}$=%4.2f, $\tau_c$=%4.2f $\tau_0$'%(reg_NP0400[0], reg_NP0400[0]/6., 1/(reg_NP0400[0]/6.)))

plt.plot(t_EQ_NP1000, MSD_EQ_NP1000, 'r-', linewidth=3, alpha=0.3, label = r'Np=1000 (repulsive Brownian), slope=%4.1f, $\tilde{D}$=%4.2f, $\tau_c$=%4.2f $\tau_0$'%(reg_EQ_NP1000[0], reg_EQ_NP1000[0]/6., 1/(reg_EQ_NP1000[0]/6.)))

plt.plot(t_NP1000, MSD_NP1000, 'r-', label = r'Np=1000 (Rt=10), slope=%4.1f, $\tilde{D}$=%4.2f, $\tau_c$=%4.2f $\tau_0$'%(reg_NP1000[0], reg_NP1000[0]/6., 1/(reg_NP1000[0]/6.)))
