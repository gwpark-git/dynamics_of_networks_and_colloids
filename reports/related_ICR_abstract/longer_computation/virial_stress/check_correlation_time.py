...
dist_NP1000 = loadtxt('dist_NP1000_NC25_RT100.dat')[:,1]
beta_NP1000 = mean(dist_NP1000[-100:])
dat.append([1000, beta_NP1000, 1./beta_NP1000, 0.500, 0.322])
...
for i in range(shape(dat)[0]):
    plt.plot(dat[i,0], dat[i,4], 'o', markersize=10, markerfacecolor=colP[i], label = 'Np=%d, tc(0.1,0.2)=%4.3f'%(dat[i,0], dat[i,4]))
...
plt.ylabel('correlation time between 0.5 and 1')
