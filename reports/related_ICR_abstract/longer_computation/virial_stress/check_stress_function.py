...
plt.plot(t_NP1000, sf_NP1000, '-', color=colP[0], label = 'Np=1000, , mean = %3.2f'%(mean_sf_NP1000))
plt.plot(t_NP1200, sf_NP1200 + 300, '-', color=colP[1], label = 'Np=1200, shifted by 300, mean = %3.2f'%(mean_sf_NP1200))
plt.plot(t_NP1400, sf_NP1400 + 600, '-', color=colP[2], label = 'Np=1400, shifted by 600, mean = %3.2f'%(mean_sf_NP1400))
# plt.plot(t_NP1000, sf_NP1000, '-', color=colP[3], label = 'Np=1000, shifted by 900, mean = %3.2f'%(mean_sf_NP1000))
