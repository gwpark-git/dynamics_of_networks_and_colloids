...
# sf_NP1000_dt001_NB10 = loadtxt('../../equilibrium_analysis_dt0_01/RF_NP1000_RT100_dt0_01.dat')[N_st:,1]
# if size(sf_NP1000_dt001_NB10) > 9000:
#     sf_NP1000_dt001_NB10 = sf_NP1000_dt001_NB10[:9000]
# acf_NP1000_dt001_NB10 = acf_gro(sf_NP1000_dt001_NB10)
# t_NP1000_dt001_NB10 = arange(size(acf_NP1000_dt001_NB10))/100.
# # mean_acf_NP1000_dt001_NB10 = mean(acf_NP1000_dt001_NB10[size(acf_NP1000_dt001_NB10)/2:])
# # mean_acf.append(mean_acf_NP1000_dt001_NB10)

# sf_NP1000_dt01_NB1 = loadtxt('../RF_NP1000_dt0_1_NB1.dat')[N_st:,1]
# if size(sf_NP1000_dt01_NB1) > 9000:
#     sf_NP1000_dt01_NB1 = sf_NP1000_dt01_NB1[:9000]

# acf_NP1000_dt01_NB1 = acf_gro(sf_NP1000_dt01_NB1)
# t_NP1000_dt01_NB1 = arange(size(acf_NP1000_dt01_NB1))/100.
# # mean_acf_NP1000_dt01_NB1 = mean(acf_NP1000_dt01_NB1[size(acf_NP1000_dt01_NB1)/2:])
# # mean_acf.append(mean_acf_NP1000_dt01_NB1)

# sf_NP1000_dt01_NB10 = loadtxt('../RF_NP1000_dt0_1_NB10.dat')[N_st:,1]
# if size(sf_NP1000_dt01_NB10) > 9000:
#     sf_NP1000_dt01_NB10 = sf_NP1000_dt01_NB10[:9000]
# acf_NP1000_dt01_NB10 = acf_gro(sf_NP1000_dt01_NB10)
# t_NP1000_dt01_NB10 = arange(size(acf_NP1000_dt01_NB10))/100.


# mean_acf_NP1000_dt01_NB10 = mean(acf_NP1000_dt01_NB10[size(acf_NP1000_dt01_NB10)/2:])
# mean_acf.append(mean_acf_NP1000_dt01_NB10)
...
plt.plot(t_NP1000_dt001_NB10, acf_NP1000_dt001_NB10/(2.*10**3), '-', color=colP[0], label = r'$dt=10^{-1} \tau_B = 10^{-3} \tau_0$, $\delta t = \tau_B = 10^{-2} \tau_0$')
plt.plot(t_NP1000_dt01_NB1, acf_NP1000_dt01_NB1/(2.*10**3), '-', color=colP[1], label = r'$dt=10^{-1} \tau_B = 10^{-3} \tau_0$, $\delta t = 10^{-1} \tau_B = 10^{-3} \tau_0$')
plt.plot(t_NP1000_dt01_NB10, acf_NP1000_dt01_NB10/(2.*10**3), '-', color=colP[2], label = r'$dt=10^{-2} \tau_B = 10^{-4} \tau_0$, $\delta t = 10^{-1} \tau_B = 10^{-3} \tau_0$')
...
# plt.plot(t_NP1000, acf_NP1000_BAV/acf_NP1000_BAV[0], '-', color=colP[3], label = r'NP=1000, $K\delta t = 1\tau_0$')
# plt.plot(t_NP1000, acf_NP1000/acf_NP1000[0], '-', color=colP[0], label = r'NP=1000, $\delta t = 0.01\tau_0$')
# plt.axis([0, 10, 0.001, 1.0])
# plt.plot(t_NP1000, acf_NP1000/acf_NP1000[0], 'b-')
...
# plt.plot(ref_vert_1[:,0], ref_vert_1[:,1], 'k-')
# plt.plot(ref_vert_2[:,0], ref_vert_2[:,1], 'k-')
# plt.plot(ref_vert_3[:,0], ref_vert_3[:,1], 'k-')
# plt.plot(ref_vert_4[:,0], ref_vert_4[:,1], 'k-')
...
# ax2.plot(t_NP0400, acf_NP0400/acf_NP0400[0], '-', color=colP[0])
