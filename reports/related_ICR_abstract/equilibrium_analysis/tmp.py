...
# N_st = 5000
# RF_NP0400 = loadtxt('RF_NP0400_NC25_longer_TMP.dat')[N_st:,1]
# acf_NP0400 = acf_gro(RF_NP0400)
# t_NP0400 = arange(size(acf_NP0400))/1000.

# RF_NP0600 = loadtxt('RF_NP0600_NC25_longer_TMP.dat')[N_st:,1]
# acf_NP0600 = acf_gro(RF_NP0600)
# t_NP0600 = arange(size(acf_NP0600))/1000.

# RF_NP0700 = loadtxt('RF_NP0700_NC25_longer_TMP.dat')[N_st:,1]
# acf_NP0700 = acf_gro(RF_NP0700)
# t_NP0700 = arange(size(acf_NP0700))/1000.


# RF_NP0800 = loadtxt('RF_NP0800_NC25_longer_TMP2.dat')[N_st:,1]
# acf_NP0800 = acf_gro(RF_NP0800)
# t_NP0800 = arange(size(acf_NP0800))/1000.
