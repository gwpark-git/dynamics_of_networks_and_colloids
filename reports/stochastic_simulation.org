...
# Recall that 
# \begin{equation}
# \delta t = R_t dt = \frac{\tau_D}{\tau_B} dt.
# \end{equation}

# If $\delta t$ is too large, it would be better to update topology several times with small factor:
# \begin{equation}
# P^{dissoc}_k = \min\left\{1, \beta_k \frac{\delta t}{Nt}\right\}
# \end{equation}
