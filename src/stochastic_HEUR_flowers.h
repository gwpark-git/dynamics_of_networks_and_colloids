...
record_virial_into_energy_array(MATRIX& energy)
{
  ...
  energy(24) = RF_connector_xx/(volume_PBC_box);
  energy(25) = RF_connector_yy/(volume_PBC_box);
  energy(26) = RF_connector_zz/(volume_PBC_box);

  energy(27) = RF_connector_xy/(volume_PBC_box);
  energy(28) = RF_connector_xz/(volume_PBC_box);
  energy(29) = RF_connector_yz/(volume_PBC_box);
