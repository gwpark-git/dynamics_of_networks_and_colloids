...
record_virial_into_energy_array(MATRIX& energy)
{
  ...
  energy(18) = RF_connector_xx/(volume_PBC_box);
  energy(19) = RF_connector_yy/(volume_PBC_box);
  energy(20) = RF_connector_zz/(volume_PBC_box);

  energy(21) = RF_connector_xy/(volume_PBC_box);
  energy(22) = RF_connector_xz/(volume_PBC_box);
  energy(23) = RF_connector_yz/(volume_PBC_box);
