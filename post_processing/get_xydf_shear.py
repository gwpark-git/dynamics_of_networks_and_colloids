...
if size(sys.argv) < 10:
    ...
    print 'argv[4] == number of blocks for time average. note that it will be ignorable blocks'
    print 'argv[5] == factor to multiplicate blocks (1 for general)'
    ...
    rdf, rho_local = get_xydf_from_traj(traj, t, dr, Np, Nt, N_dimension, box_dimension, cut_ratio)
    # else:
